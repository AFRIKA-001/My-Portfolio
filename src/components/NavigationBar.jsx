...
export default function NavigationBar(){
    ...
    return<>
    <section   className="w-full h-22 bg-[#0a132b] flex text-xl font-bold content-evenly">
        <h1 className="text-transparent bg-clip-text bg-gradient-to-r from-[#B82FF6] to-[#EE8425] font-bold text-4xl p-8"><span className="text-5xl">G</span>abriel</h1>
