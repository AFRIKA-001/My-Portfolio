        ...
        <section  className='font-sm '>
            ...
            <div className='grid lg:grid-cols-2'>
                ...
                <div className='grid grid-rows-3 justify-items-center'>
                    ...
                    <input className=' my-8 pl-1 w-full bg-white/10 border-white/10 text-white/90 border rounded' type="text" required/>


                    <label className='text-white pt-15 pr-70 lg:pr-135 uppercase font-mono '>Email Address</label>
                    <input className='h-10 pl-1  w-full bg-white/10 border-white/10 text-white/90 border rounded' type="email" placeholder='johndoe@gmail.com' required />


                    <label className='text-white py-5 pr-85 lg:pr-145 uppercase'>Message</label>
                    <textarea className='pl-1 w-full bg-white/10 border-white/10 text-white/90 border rounded' type="textarea" placeholder='what is your project idea' required>
                    </textarea>
