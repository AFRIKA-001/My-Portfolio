    ...
    <section className="relative overflow-hidden min-h-screen mt-20">
      ...
      <div className=" text-center">
        ...
        <div className="mt-12 flex items-center justify-center gap-5">
          ...
          <Link
            to="/projects"
            className="px-8 py-4 rounded-2xl border bg-black hover:border-white-400/10 hover:bg-slate-500 active:bg-black transition-all duration-300 text-white font-semibold shadow-lg shadow-slate-700 hover:scale-105"
          >
            View Projects
          </Link>
          ...
          <Link
            to="/contacts"
            className="px-8 py-4 rounded-2xl border bg-black active:bg-black hover:bg-slate-500  text-slate-200 hover:text-white transition-all duration-300 shadow-lg shadow-slate-700 hover:scale-105"
          >
            Contact Me
          </Link>
        </div>
        ...
        {/* Tech Stack Pills */}
         <div className="mt-14 flex flex-wrap justify-center gap-4">
          ...
          {[
            ...
            <span
              key={i}
              className="px-5 py-2 rounded-full bg-black border border-slate-700 text-slate-300 hover:border-cyan-400 hover:text-white transition"
            >
              {tech}
            </span>
          ))}
