 import ProfilePic from '../public/myface2.png' 
  ...
  export default function AboutPage() {
    ...
    return <>
    <section className='bg-[#0B1120] mt-10  lg:pb-25 items-center '>
        ...
        <p className='text-xl flex text-center max-w-md px-4 pt-10 text-white font-medium leading-relaxed'>
