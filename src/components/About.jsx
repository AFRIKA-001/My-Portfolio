 import ProfilePic from '../public/output.jpg' 
  ...
  export default function AboutPage() {
    ...
    <section className='mb-10  '>
        ...
        <p className='text-xl flex text-center font-serif lg:pr-9 pt-10 text-white font-medium leading-relaxed backdrop-blur-md bg-white/10 border-b border-white border-r'>
